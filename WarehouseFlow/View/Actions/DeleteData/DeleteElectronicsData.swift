...
struct DeleteElectronicsData: View {
            ...
            VStack{
                ...
                List(modelDelete.actions){item in
                    HStack{
                        ...
                        Button(action: {
                            modelDelete.deleteElectronicData(deleteItem: item)
                            showAlert = true
                        }, label: {
    ...
    init(){
        modelDelete.getElectronicData()
    }}

struct DeleteElectronicsData_Previews: PreviewProvider {
    static var previews: some View {
        DeleteElectronicsData()
    }
}
