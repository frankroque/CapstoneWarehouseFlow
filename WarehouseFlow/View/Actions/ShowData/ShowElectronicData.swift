...
struct ShowElectronicData: View {
    ...
    var body: some View {
        ZStack{
            ...
            VStack{
                Text("Displaying Electronics Data").font(.largeTitle).multilineTextAlignment(.center).padding()
                Spacer()
                HStack{
                    Text("Product Name")
                        .bold()
...
struct ShowElectronicData_Previews: PreviewProvider {
